...
export default function AdminView(props) {
  ...
  const [newGameRating, addGameRating] = useState("");
  const [newGameImage, addGameImage] = useState("");
  const [newGameInfo, addGameInfo] = useState("");

  const addNewGame = () => {
    props.addNewGame(newGameName, newGameDeveloper, newGamePublisher, newGameConsole, newGameGenre, newGamePrice, newGameRating, newGameImage, newGameInfo);
  }
  ...
  return (
    <div>
      <div>
          ...
          <div>
            Genre <input type="text" onChange={ (event) => addGameGenre(event.target.value) } />
          </div>
          <div>
            Price <input type="text" onChange={ (event) => addGamePrice(event.target.value) } />
          </div>
          <div>
            Rating <input type="text" onChange={ (event) => addGameRating(event.target.value) } />
          </div>
          <div>
            Image <input type="text" onChange={ (event) => addGameImage(event.target.value) } />
          </div>
          <div>
            Info <input type="text" onChange={ (event) => addGameInfo(event.target.value) } />
          </div>
